    ...
    internal static class TestData
    {
            ...
            foreach (var ul in TestValue.Licenses)
            {
                ...
                if (ul.ServicePlans != null)
                {
                    foreach (var sp in ul.ServicePlans)
                    {
                        ...
                        if (sp.ServicePlanId != null)
                        {
                            sppb.ServicePlanId = sp.ServicePlanId;
                        }

                        if (sp.ServicePlanName != null)
                        {
        ...
        public static readonly UserLicensesResponse TestValue = new UserLicensesResponse
        {
            Licenses = new[]
            {
                ...
                new UserLicense
                {
                    ObjectId = "v4j5cvGGr0GRqy180BHbR4-OoSYUTfhGg1rtO6QkqWE",
                ...
                new UserLicense
                {
                    ...
                    SkuPartNumber = "ryukryukryukyruk",
                    ServicePlans = new[]
                    {
                ...
                new UserLicense
                {
                    ...
                    SkuPartNumber = "tyejetyjetyjetyj",
                    ServicePlans = new[]
                    {
                ...
                new UserLicense
                {
                    ...
                    SkuPartNumber = "ryukryukryukyukryuk",
                    ServicePlans = new[]
                    {
                ...
                new UserLicense
                {
                    ...
                    SkuPartNumber = "yrukryukgfgjmmtyutyukryuk",
                    ServicePlans = new[]
                    {
